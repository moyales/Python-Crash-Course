...
# Use the final version of electric_car.py and 
# add a method called upgrade_battery() to Battery class.

# Check the battery size and set capacity to 85 if it is not already.
# Make an electric car wiht a default battery size, call get_range() once,
